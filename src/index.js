...
// 合約地址配置 - v2.0.2 更新後的地址（2025-07-17 部署）
const CONTRACTS = {
  hero: process.env.VITE_MAINNET_HERO_ADDRESS || '0xaa3166b87648F10E7C8A59f000E48d21A1A048C1',
  relic: process.env.VITE_MAINNET_RELIC_ADDRESS || '0x7023E506A9AD9339D5150c1c9F767A422066D3Df',
  party: process.env.VITE_MAINNET_PARTY_ADDRESS || '0xb069B70d61f96bE5f5529dE216538766672f1096',
  vip: process.env.VITE_MAINNET_VIPSTAKING_ADDRESS || '0x769C47058c786A9d1b0948922Db70A56394c96FD',
  playerprofile: process.env.VITE_MAINNET_PLAYERPROFILE_ADDRESS || '0x861CFCA7af4E6005884CF3fE89C2a5Cf3d6F3c85'
};
